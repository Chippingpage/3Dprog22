...
SceneHouse::SceneHouse(float scale, QVector3D start)
{
    m_Position = start;
...
//    Vertex v36{m_Position[0] + StartPos[0] - scale*4, m_Position[1] + StartPos[1] + scale*3, m_Position[2] + StartPos[2], HouseColour[0], HouseColour[1], HouseColour[2]};
    ...
    SceneHousePoints.push_back(v1);
    SceneHousePoints.push_back(v2);
    SceneHousePoints.push_back(v3);
    SceneHousePoints.push_back(v4);
    SceneHousePoints.push_back(v5);
    SceneHousePoints.push_back(v6);
...
//    HousePoints.push_back(v18);
    ...
    SceneHousePoints.push_back(v19);
    SceneHousePoints.push_back(v20);
    SceneHousePoints.push_back(v21);
    SceneHousePoints.push_back(v22);
    SceneHousePoints.push_back(v23);
    SceneHousePoints.push_back(v24);

    SceneHousePoints.push_back(v25);
    SceneHousePoints.push_back(v26);
    SceneHousePoints.push_back(v27);
    SceneHousePoints.push_back(v28);
    SceneHousePoints.push_back(v29);
    SceneHousePoints.push_back(v30);
...
//    HousePoints.push_back(v36);
    ...
    SceneHousePoints.push_back(v61);
    SceneHousePoints.push_back(v62);
    SceneHousePoints.push_back(v63);
    SceneHousePoints.push_back(v64);
    SceneHousePoints.push_back(v65);
    SceneHousePoints.push_back(v66);

    for (int i = 0; i < SceneHousePoints.size(); i++)
    {
        mVertices.push_back(SceneHousePoints[i]);
    }
...
void SceneHouse::init(GLint matrixUniform) {
